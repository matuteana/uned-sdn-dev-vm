...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "file", source: "scripts/vm_files/Desktop/README.txt", destination: "~vagrant/Desktop/README"
  config.vm.provision "file", source: "scripts/vm_files/Desktop/Using_Chrome.txt", destination: "~vagrant/Desktop/Using_Chrome"
  config.vm.provision "file", source: "scripts/vm_files/Desktop/ODL_and_mininet.txt", destination: "~vagrant/Desktop/ODL_and_mininet"
    config.vm.provision "file", source: "scripts/vm_files/Desktop/ODL_and_VIRL.txt", destination: "~vagrant/Desktop/ODL_and_VIRL"
